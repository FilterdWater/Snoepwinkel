                    ...
                    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-2 shadow-inner rounded bg-rose-500 p-4">
                        ...
                        <div>
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                ...
                                <li>
                                <a href="https://github.com/FilterdWater/Snoepwinkel" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" text-white w-8 h-8" viewBox="0 0 16 16">
