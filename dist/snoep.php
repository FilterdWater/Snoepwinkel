            ...
            <div class="container py-24 mx-auto">
                <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 justify-evenly">
                    ...
                    foreach ($products as $product) {
                        echo '<div class="p-4 m-auto mb-6 outline outline-cyan-700 rounded mx-6">';
                        echo '  <div class="rounded-lg h-64 w-auto overflow-hidden flex ">';
                        echo '    <img alt="product" class="object-contain h-auto w-52" src="' . $product['picture'] . '">';
                        echo '  </div>';
                        echo '  <div class="mt-5">';
